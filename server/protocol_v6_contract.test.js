...
// defaults to the recipient's current transport generation.
{
    ...
    assert.equal(outbound.protocolVersion, 12);
...
console.log('protocol v12 cut-over tests passed');
