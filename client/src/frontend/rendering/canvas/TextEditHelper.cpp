...
// Mouffette includes trailing spaces in alignment as well as hit-testing:
// center/right align the complete string, including its trailing spaces.
// After every layout pass, synchronize textAdvance with textWidth for ALL
// alignments. The fill and outline both read this same patched document.
// -----------------------------------------------------------------------
