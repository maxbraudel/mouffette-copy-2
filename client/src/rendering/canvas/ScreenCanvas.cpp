...
#include "network/WebSocketClient.h" // for remote scene start/stop messaging
#include "network/UploadManager.h" // for upload state checking
#include "domain/session/SessionManager.h" // Phase 3: For DEFAULT_IDEA_ID constant
#include <QTimer>
#include "core/AppColors.h"
#include "files/Theme.h"
#include "domain/media/MediaItems.h"
#include "domain/media/MediaSettingsPanel.h" // for settingsPanel() accessor usage
#include "ui/notifications/ToastNotificationSystem.h" // for toast notifications
...
#ifdef Q_OS_MACOS
#include "platform/macos/MacVideoThumbnailer.h"
#endif
#ifdef Q_OS_WIN
